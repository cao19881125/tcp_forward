...
class OuterDataHandler(DataHandler):
    def handle_data(self,ring_buffer,inner_worker_manager,outer_connector):
        while True:
            ...
            elif parsed_data.data_type == forward_data.DATA_TYPE.PRE_WORKING:

                tag = CfgManager.get_instance().get_cfg().get('DEFAULT', 'TAG')
